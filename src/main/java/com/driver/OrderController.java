...
orderService.addOrder(order);
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        orderService.OrderPartnerPair(orderId,partnerId);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        DeliveryPartner deliveryPartner = orderService.findPartner(partnerId);
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.getOrdersLeftAfterGivenTimeByPartnerId(LocalDateTime.parse(time),partnerId);
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        String time = orderService.getlastdeliverordertime(partnerId);
